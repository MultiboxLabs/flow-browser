...
(function () {
  ...
  Runner.prototype = {
    ...
    init: function () {
      ...
      try {
        const savedHighestScoreStr = localStorage.getItem(
          "chrome.dino.highest_score"
        );
        const savedHighestScore = Number(savedHighestScoreStr);
        this.highestScore = savedHighestScore;
        this.distanceMeter.setHighScore(savedHighestScore);
      } catch {}
    ...
    gameOver: function () {
      ...
      if (this.distanceRan > this.highestScore) {
        ...
        try {
          localStorage.setItem("chrome.dino.highest_score", this.highestScore);
        } catch {}
      }
