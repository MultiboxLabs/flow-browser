  ...
  return (
    ...
    >
      ...
      <Menu as="div" className="text-xs relative">
        ...
        >
          <Menu.Items className="absolute right-0 z-popover mt-2 origin-top-right rounded-sm text-left dark:bg-slate-700 bg-white dark:divide-slate-500 divide-y divide-slate-200 shadow-lg ring-1 dark:ring-white/10 ring-black/5 focus:outline-none">
